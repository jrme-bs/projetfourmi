...
public class Terrain {
	...
	int tailleZone = 17;
	// nombre de colonne et de ligne pour mieu r√©cup√©rer les zones dans la map
	private int nbCol;
	private int nbLigne;
	...
	public void etapeDeSimulation(ContexteDeSimulation contexte) {
		// crÈÈe la grille de zone si elle n'a pas ÈtÈ crÈÈe
		if (this.mapZone.isEmpty()) {
			...
			for (Map.Entry<Integer, Zone> entry : mapZone.entrySet()) {
			    ...
			    //System.out.println("Cl√© (index): " + entry.getKey() + ", Valeur (zone): " + entry.getValue());
